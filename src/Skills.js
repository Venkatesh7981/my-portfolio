...
function Skills() {
    ...
    if (type === "Tools") {
      ...
      return (
        <div className="m-lg-5 m-0 d-flex gap-4 flex-wrap ">
          ...
          <Skilltag name="Redux Toolkit" icon="devicon-redux-original colored" />
        </div>
      );
  ...
  return (
    <div>
      <h3 className="text-center fw-bold" style={{ marginTop: "4%", height: "100%" }}>
        My Skills
      </h3>
      <div className="d-flex justify-content-center align-items-center" style={{ width: "100%", height: "100%", padding: 0 }}>
        <div className="d-flex flex-row flex-wrap" style={{ width: "90%", maxHeight: "420px", minHeight: "420px" }}>
          <div data-aos="zoom-in" data-aos-duration="1500" style={{ width: "40%" }} className="d-flex justify-content-center align-items-center flex-column skillcontainer mobileview">
            <Skilltype func={onclickfunc} type="Frontend skills" current={type} icon1="fa-solid fa-code" />
            <Skilltype func={onclickfunc} type="Backend skills" current={type} icon1="fa-solid fa-hat-cowboy" />
            <Skilltype func={onclickfunc} type="programming" current={type} icon1="fa-solid fa-laptop-code" />
            <Skilltype func={onclickfunc} type="Tools" current={type} icon1="fa-solid fa-toolbox" />
          </div>
